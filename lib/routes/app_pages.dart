...
import 'package:pure_live/modules/live_play/multi_live_page.dart';
...
import 'package:pure_live/modules/live_play/multi_live_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: RoutePath.kMultiLivePlay,
      page: () => MultiLivePage(),
      preventDuplicates: false,
      bindings: [MultiLiveBinding()],
    ),
    //账号设置
    GetPage(
